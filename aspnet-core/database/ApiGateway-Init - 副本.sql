...
-- ----------------------------
DELETE FROM `appapigatewayaggregate`;
...
-- ----------------------------
DELETE FROM `appapigatewayauthoptions`;
...
-- ----------------------------
DELETE FROM `appapigatewaybalanceroptions`;
...
-- ----------------------------
DELETE FROM `appapigatewaycacheoptions`;
...
-- ----------------------------
DELETE FROM `appapigatewaydiscovery`;
...
-- ----------------------------
DELETE FROM `appapigatewayglobalconfiguration`;
...
-- ----------------------------
DELETE FROM `appapigatewayhttpoptions`;
...
-- ----------------------------
DELETE FROM `appapigatewayqosoptions`;
...
-- ----------------------------
DELETE FROM `appapigatewayratelimitoptions`;
...
-- ----------------------------
DELETE FROM `appapigatewayratelimitrule`;
...
-- ----------------------------
DELETE FROM `appapigatewayreroute`;
...
-- ----------------------------
DELETE FROM `appapigatewayroutegroup`;
...
-- ----------------------------
DELETE FROM `appapigatewaysecurityoptions`;
